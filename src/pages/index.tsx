      ...
      <div className="flex-1 embed-inputs">
        ...
        <details open>
          <summary>
            <h2>
              Author
              {authorName ? <> &ndash; {ellipses(authorName)}</> : null}
            </h2>
          </summary>
          <ValueInput
            label="Author Name"
            ...
            limit={256}
          />
          <ValueInput label="Author URL" value={[authorUrl, setAuthorUrl]} />
          <ValueInput
        ...
        <details open>
          ...
          <ValueInput label="Title" value={[title, setTitle]} limit={256} />
            ...
            <details key={index}>
              <summary>
                <h3 className="text-white font-semibold mr-auto">
                  Field {index + 1} &ndash; {ellipses(field.name)}
                </h3>
                <button
                  onClick={() => {
                    if (index === 0) return;
                  ...
                  className={button(index === 0 ? "disabled" : "blue")}
                >
                  Move Up
                </button>
                <button
                  ...
                  className={button(
                    index === fields.length - 1 ? "disabled" : "blue"
                  )}
                >
                  Move Down
                </button>
              ...
              <div className="flex items-center justify-start gap-2">
                <label htmlFor={`field-inline-${index}`}>Inline</label>
                <input
                  type="checkbox"
        ...
        <details open>
          ...
          <ValueInput label="Thumbnail URL" value={[thumbnail, setThumbnail]} />
        </details>
        <details open>
          <summary>
            <h2>
              Footer
              {footerText ? <> &ndash; {ellipses(footerText)}</> : null}
            </h2>
          </summary>
          <ValueInput
            label="Footer Text"
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              checked={!!timestamp}
              onChange={(e) =>
                setTimestamp(e.target.checked ? Date.now() : undefined)
              }
              className="mt-2"
            />
          </div>
      ...
      {modal ? (
        <>
          ...
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#292b2f] p-4 rounded">
            ...
            <p className="mb-1">The short link will be valid for one week.</p>
            ...
            <Copier
              ...
              loadingClassName={`${button("disabled")} animate-pulse`}
